...
MBI5030::MBI5030(uint8_t spi_out_pin, uint8_t spi_in_pin, uint8_t spi_clk_pin, uint8_t spi_latch_pin) {
...
uint16_t MBI5030::read_register(void) {
  ...
  // read bits 0-14
  for(register_status_bit = 0; register_status_bit <= 14; register_status_bit++) {
